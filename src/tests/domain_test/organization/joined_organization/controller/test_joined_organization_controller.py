...
async def test_change_role(client: AsyncClient):
    ...
    response = await client.put("/joined-organization/1", json=ChangeRoleDto(
        member_id=3,
...
async def test_get_all(client: AsyncClient):
    await login(client, LoginFormDTO(email="test_user0@user.com", password="password"))
    response = await client.get("/joined-organization/")
    assert response.status_code == status.HTTP_200_OK

@pytest.mark.asyncio
async def test_delete_joined_organization(client: AsyncClient):
    await login(client, LoginFormDTO(email="test_user0@user.com", password="password"))
    response = await client.delete("/joined-organization/", params={
        "organization_id": 1,
...
@pytest.mark.asyncio
async def test_change_role_fail1(client: AsyncClient):
    await login(client, LoginFormDTO(email="test_user0@user.com", password="password"))
    response = await client.put("/joined-organization/1", json=ChangeRoleDto(
        member_id=3,
...
@pytest.mark.asyncio
async def test_change_role_fail2(client: AsyncClient):
    await login(client, LoginFormDTO(email="test_user0@user.com", password="password"))
    response = await client.put("/joined-organization/1", json=ChangeRoleDto(
        member_id=100,
...
@pytest.mark.asyncio
async def test_change_role_fail3(client: AsyncClient):
    await login(client, LoginFormDTO(email="test_user0@user.com", password="password"))
    response = await client.put("/joined-organization/1", json=ChangeRoleDto(
        member_id=2,
        member_role=MemberRole.READ_ONLY,
...
# wrong organization
@pytest.mark.asyncio
async def test_delete_joined_organization_fail1(client: AsyncClient):
    await login(client, LoginFormDTO(email="test_user3@user.com", password="password"))
    response = await client.delete("/joined-organization/", params={
        "organization_id": 1,
        "joined_organization_id": 2,
    })
...
@pytest.mark.asyncio
async def test_delete_joined_organization_fail2(client: AsyncClient):
    await login(client, LoginFormDTO(email="test_user0@user.com", password="password"))
    response = await client.delete("/joined-organization/", params={
        "organization_id": 1,
